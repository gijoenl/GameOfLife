...
public class GameOfLifeController extends JPanel {                              // This class handles the display of the game in a JFrame
    
    boolean[][] cells;                                                          // VARIABLES AND OBJECTS
    double width;
    double height;
    
    public GameOfLifeController(boolean[][] in) {                               // now the cells of the Main method and these are pointing on the same thing
        cells = in;
    }
